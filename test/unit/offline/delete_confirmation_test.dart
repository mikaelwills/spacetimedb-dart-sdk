  ...
  group('Delete Confirmation Bug Fix', () {
    ...
    group('Test 1: Zombie Resurrection Check', () {
      test(
        ...
        () async {
          ...
          optimistic.applyOptimisticChanges('req-delete-100', [
      ...
      test('without fix, row would be incorrectly restored', () {
        ...
        optimistic.applyOptimisticChanges('req-delete-101', [
          OptimisticChange.delete('note', note.toJson()),
        ]);
    ...
    group('Test 2: Safety Net - Rollback Check', () {
      test('optimistic delete + server rejects = row is restored', () {
        ...
        optimistic.applyOptimisticChanges('req-delete-200', [
          OptimisticChange.delete('note', note.toJson()),
        ]);
        ...
        optimistic.confirmOrRollbackWithTouchedKeys('req-delete-200', {
          'note': touchedKeys,
        });
    ...
    group('Test 3: Batch Check - Rapid Fire Deletes', () {
      test('multiple parallel deletes all stay deleted', () async {
        ...
        optimistic.confirmOrRollbackWithTouchedKeys('req-batch', {
          'note': touchedKeys,
        });
      ...
      test('partial batch - some confirmed, some rolled back', () {
        ...
        optimistic.confirmOrRollbackWithTouchedKeys('req-partial', {
          'note': touchedKeys,
        });

        expect(cache.find(304), isNull, reason: 'Note A was confirmed deleted');
        expect(
          cache.find(305)?.id,
          equals(305),
    ...
    group('Test 4: Already Gone Check (Offline Sync)', () {
      ...
      test('offline sync with pending delete - row stays deleted', () async {
        ...
        optimistic.applyOptimisticChanges('req-create', [
        ...
        expect(
          optimistic.hasOptimisticChange('req-delete'),
          isTrue,
        ...
        optimistic.confirmOrRollbackWithTouchedKeys('req-delete', {
          'note': touchedKeys,
        });
    ...
    group('Edge Cases', () {
      ...
      test('delete with server sending different row version', () {
        ...
        expect(cache.find(600), isNull, reason: 'Row should stay deleted');
      });
    });
  });
}
