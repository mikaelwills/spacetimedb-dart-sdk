...
void main() {
  ...
  group('Queue replay policy end-to-end', () {
    ...
    test('TTL and bounds together: expired drop AND overflow drop both shed, '
        'newest survives', () async {
    ...
    test(
      ...
      () async {
        ...
        expect(
          env.subManager.syncState.recentFailures,
          hasLength(2),
